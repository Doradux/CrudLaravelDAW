...
Route::post('categories/login', [App\Http\Controllers\CategoryController::class, 'login']);
Route::get('categories/logout', [App\Http\Controllers\CategoryController::class, 'logout']);
Route::get('categories/login', [App\Http\Controllers\CategoryController::class, 'index']);
